...
--//------------------------------------------------------------------------------------------\\--
for i,v in pairs(Settings['Made By Antoniogiallo'].STANDS) do 
if game:GetService("Players").LocalPlayer.Name == v then
    loadstring(game:HttpGet("https://raw.githubusercontent.com/lol123456543245/jojo1/refs/heads/main/jojo2"))()
    STAND = game:GetService("Players"):FindFirstChild(tostring(v))
    OWNER = game:GetService("Players"):WaitForChild(Settings['Made By Antoniogiallo'].OWNER)
...
--//------------------------------------------------------------------------------------------\\--
    game:GetService("Players").PlayerAdded:Connect(function(Player)
        if Player:WaitForChild("Name") == Settings['Made By Antoniogiallo'].OWNER then
            OWNER = Player
        end
        if Settings['Made By Antoniogiallo'].ANTIBAN then
...
--//------------------------------------------------------------------------------------------\\-
    if tonumber(Settings['Made By Antoniogiallo'].FPS) then
        setfpscap(Settings['Made By Antoniogiallo'].FPS)
    end
--//------------------------------------------------------------------------------------------\\-
    if Settings['Made By Antoniogiallo'].PERFORMANCE then
...
--//------------------------------------------------------------------------------------------\\-
if Settings['Made By Antoniogiallo'].TITAN.GODV3 then
    pcall(function()
...
--//------------------------------------------------------------------------------------------\\-
  if Settings['Made By Antoniogiallo'].TITAN.ENABLED then
	...
	repeat wait() until STAND.Backpack:FindFirstChild("Mask")
		...
		local function rm()
			...
			wide = false
			default = false
			if Settings['Made By Antoniogiallo'].TITAN.TALL and wide == false and default == false then
				tall = true
			...
			if Settings['Made By Antoniogiallo'].TITAN.WIDE and tall == false and default == false then
				wide = true
				if STAND.Character.Humanoid:FindFirstChild("HeadScale") then
					rm()
					wait(0.6)
			...
			if Settings['Made By Antoniogiallo'].TITAN.DEFAULT and tall == false and wide == false then
				default = true
				if STAND.Character.Humanoid:FindFirstChild("HeadScale") then
					rm()
					wait(0.6)
...
--//------------------------------------------------------------------------------------------\\--
    if Settings['Made By Antoniogiallo'].FACELESS then
...
--//------------------------------------------------------------------------------------------\\--
    ...
    if Settings['Made By Antoniogiallo'].LEGS then
		STAND.Character.RightUpperLeg:Destroy()
		STAND.Character.LeftUpperLeg:Destroy()
    end
--//------------------------------------------------------------------------------------------\\--
if Settings['Made By Antoniogiallo'].TRAILS then
    coroutine.wrap(function()
...
--//------------------------------------------------------------------------------------------\\-- 
if Settings['Made By Antoniogiallo'].TELEPORTMAIN then
    pcall(function()
...
--//------------------------------------------------------------------------------------------\\--
if Settings['Made By Antoniogiallo'].FOLLOWANIM then
    local Glide = Instance.new('Animation', game:GetService("Workspace"))
    Glide.AnimationId = 'rbxassetid://'.. tonumber(Settings['Made By Antoniogiallo'].FOLLOWANIM.ID)
    Glide.Name = "Follow"
    ...
    function Moved()
        if OWNER.Character:WaitForChild("Humanoid").MoveDirection.magnitude > 0 then
          if Glide2.IsPlaying == true then
            ...
            Glide2:Play(tonumber(Settings['Made By Antoniogiallo'].FOLLOWANIM.SPEED))
          else
            Glide2:Stop(tonumber(Settings['Made By Antoniogiallo'].FOLLOWANIM.SPEED))
          end     
       end
...
--//------------------------------------------------------------------------------------------\\--
if Settings['Made By Antoniogiallo'].NOCLIP.SynapseX then
    ...
    local x = Settings['Made By Antoniogiallo'].NOCLIP.Offset
...
coroutine.wrap(function()
    ...
    local success, err = pcall(function()
        if STAND.Character.BodyEffects.Attacking.Value == true then
          for i,v in pairs(game:GetService('Players'):GetPlayers()) do
              if (v.Character.HumanoidRootPart.Position - STAND.Character.LeftHand.Position).Magnitude <= (Settings['Made By Antoniogiallo'].RANGE) then 
                if STAND.Character:FindFirstChildOfClass("Tool") then
                    if STAND.Character:FindFirstChildOfClass("Tool"):FindFirstChild('Handle') then
                        ...
                        firetouchinterest(STAND.Character['LeftHand'], v.Character.UpperTorso, 0)
                            if Settings['Made By Antoniogiallo'].LEGS == false then
...
--//------------------------------------------------------------------------------------------\\--
if Settings['Made By Antoniogiallo'].ANTIFLING then
    coroutine.wrap(function()
...
--//------------------------------------------------------------------------------------------\\--
coroutine.wrap(function()
    while Settings['Made By Antoniogiallo'].AUTOPICKUPCASH == true do
        wait()
